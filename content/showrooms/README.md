...
Amazon marketplace-country wave: one source-checked chair dealer was added in each of Ireland, Turkey and Egypt. Exact model trials and hours remain unknown. The Istanbul and Cairo pins are explicitly approximate, and each page tells visitors to confirm access before travelling. Evidence: `research/amazon-marketplace-showroom-wave-20260918.json`.

Ireland/Turkey/Egypt expansion: eight additional showroom records brought every current Amazon Associates marketplace country above the two-store threshold used for indexable country landing pages. Sources include official Humanscale and Herman Miller location pages plus showroom operators' own pages. Address candidates had to pass score and national-boundary checks; exact model trials remain unknown. Evidence: `research/ie-tr-eg-showroom-expansion-20260918.json`.
