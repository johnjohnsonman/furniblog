...
export const productContentHubs: Record<string, ProductContentHub> = {
  "herman-miller-aeron": {
    ...
    explainers: [
      { title: "Recognize the support configuration", body: "This verified rear view shows a Remastered Aeron with PostureFit SL. A rear photo helps identify the fitted support; it does not establish frame size or condition.", image: "https://bvytheznlotwgavmytfr.supabase.co/storage/v1/object/public/gallery/chairpedia-1782723042902.webp", alt: "Herman Miller Aeron Remastered rear view with PostureFit SL support", caption: "Verified Remastered rear view. Chairpedia library; manufacturer marketing image retained under the site's owner-policy record.", href: "/chairpedia/herman-miller-aeron-chair-review", cta: "Review Aeron configurations" },
    ],
    guides: [
