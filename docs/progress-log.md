...
> 2026-09-25에 `CLAUDE.md`에서 원문 그대로 이동했습니다. 새 기록은 이 파일 맨 아래에 날짜 섹션으로 추가합니다.
> ⚠️ 2026-09-12 이전 기록은 도메인을 `furniblog.com`으로 적고 있습니다. 현재 대표 주소는 `https://www.chairpedia.com`입니다(`docs/chairpedia-domain-migration.md`). 기록이 서로 다르면 **날짜가 늦은 쪽**을 따릅니다.
...
- Leap V2 허브 배포: 공식 근거 5개, V1 카드(식별 가이드로), 선택 4단계, 가이드 3, 비교 8(검증 5 + Amia·Karman·Contessa II), 공식 출처 3. 가이드 3개에 허브로 돌아가기 상자.
