...
async function main() {
 ...
 const paths=['/stores','/stores/locations','/stores/locations/united-kingdom/london','/stores/locations/france','/stores/locations/italy','/stores/locations/spain','/stores/locations/kenya/nairobi'];
