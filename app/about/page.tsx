...
export default function AboutPage() {
  ...
  return <div className="flex min-h-screen flex-col"><Header />
    <main className="flex-1">
      ...
      <section className="border-b border-border bg-card"><div className="mx-auto max-w-3xl px-4 py-16 sm:py-20"><p className="text-xs font-medium uppercase tracking-[.18em] text-muted-foreground">Chairpedia · Formerly Furniblog</p><h1 className="mt-4 font-serif text-4xl leading-tight">Chair research grounded in identifiable sources.</h1><p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">Chairpedia is building a global reference for chair models, configurations, specifications, comparisons and places to try them.</p></div></section>
