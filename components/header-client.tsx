...
import { filterShowroomLinks } from "@/lib/navigation/showrooms"
...
export function HeaderClient({ showStores }: { showStores: boolean }) {
  const pathname = usePathname()
  const visibleMainNav = filterShowroomLinks(mainNav, showStores)
