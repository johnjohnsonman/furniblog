...
export function DocumentedProductResearch({ slug }: { slug: string }) {
  ...
  return <section className="mt-8 border border-border p-5" aria-labelledby="documented-research-title">
    ...
    <p className="mt-4 text-sm leading-6 text-muted-foreground">These official documents support the configuration checks above. The core-field counter measures entries in the structured fit record; linked documents alone do not fill missing measurements or verify every configuration.</p>
